            ...
            <c:forEach items="${listaUsuario}" var="usuario">
                <tr>
                  ...
                  <td class="mdl-data-table__cell--non-numeric">
                      ...
                      <a href="${pageContext.request.contextPath}/delete?id=${usuario.idUsuario}" class="mdl-button mdl-js-button mdl-button--icon">
...
<div class="demo-cards mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet mdl-grid mdl-grid--no-spacing">
    <div class="demo-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
      ...
      <c:url var="urlsave" value="${pageContext.request.contextPath}/save" />
...
(function() {
  ...
  showToastButton.addEventListener('click', function() {
    'use strict';
    var data = {message: 'User added. #' + ++counter};
